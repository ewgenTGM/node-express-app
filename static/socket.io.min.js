						...
						(n = [
							...
							},
							{
								...
								value: function (t) {
									...
									c(l(f.prototype), 'emit', this).apply(
										this,
										t
									);
								},
				...
				return (
					...
					(n = [
						...
						},
						{
							...
							value: function (t, e) {
								return (
									s(f(l.prototype), 'once', this).call(
										this,
										t,
										e
									),
								...
								value: function () {
									this.script &&
										...
										this.form &&
											...
											(this.form = null),
											(this.iframe = null)),
										i(f(p.prototype), 'doClose', this).call(
											this
										);
								},
							},
